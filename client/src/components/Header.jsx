    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>"Effortlessly erase backgrounds from any image with just a click." <br className='max-sm:hidden' />"Get flawless, high-quality results in seconds."<br className='max-sm:hidden' />"It's as simple as upload, remove, and download!"" </p>
                <div>
